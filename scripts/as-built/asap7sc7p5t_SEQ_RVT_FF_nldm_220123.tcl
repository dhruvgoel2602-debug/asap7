...
set LEF_FILES {}
set DB_FILES {/home/vlsilab/SynopsysFlow/db_out/asap7sc7p5t_SEQ_RVT_FF_nldm_220123.db}
...
create_workspace asap7sc7p5t_SEQ_RVT_FF_nldm_220123 -scale_factor 4000
foreach frame $FRAME_LIBS {
  read_ndm $frame
}
read_db $DB_FILES
process_workspaces -check_options {-allow_missing} -force -directory CLIBs -output asap7sc7p5t_SEQ_RVT_FF_nldm_220123.ndm
