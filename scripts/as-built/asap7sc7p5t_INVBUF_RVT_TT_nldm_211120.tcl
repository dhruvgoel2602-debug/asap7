...
create_workspace asap7sc7p5t_INVBUF_RVT_TT_nldm_211120 -scale_factor 4000
foreach frame $FRAME_LIBS {
  read_ndm $frame
}
read_db $DB_FILES
process_workspaces -check_options {-allow_missing} -force -directory CLIBs -output asap7sc7p5t_INVBUF_RVT_TT_nldm_211120.ndm
